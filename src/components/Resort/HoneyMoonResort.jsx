...
export default class HoneyMoonResort extends Component {
    render() {
        return (
            <div>
                <View BackgroundImage={fog}heading="Honey Moon Resorts" content={
                    <Cards cardImage={fogvilla} title="FOG RESORTS" content="
                    
                    Ever imagined how a blend of Nature and Luxury Resort could create wonder?
