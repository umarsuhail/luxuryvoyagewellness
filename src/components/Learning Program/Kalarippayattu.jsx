            ...
            <div className="vc_column-inner ">
              <div className="wpb_wrapper">
                <div className="wpb_text_column wpb_content_element ">
                  <div className="wpb_wrapper">
                  <p>Kalarippayattu Training One Month @ 600 € (Food and ccomodation)</p>
                    <p>
                    ...
                    practiced extensively in Kerala. The word is spelled variously as kalari payat, 
                    kalarippayatta, kalaripayatt and many others depending on the dialect and 
                    ...
                    <p>The training is imparted at our school is direct supervision of our first-born gurus, 
                        ...
                        is cherished and heighten with traditionally followed rituals in daily basis and in occasional 
                        in regard with special days. The right energy in the right ambience is going to make the 
                        change within you to fine tune your internal environment to shorten this celestial art form. 
                        When you are at our center, our training genre includes various training manuals, Visiting 
                        historical places etc. Our tailor made education programs suits you to every need. We designed 
                        varieties of training packages and also custom made packages to provide a outright training to 
                        ...
                        <p>The training will be initiated at our school in a traditional ritualistic manner. 
                            ...
                            <p>Some of the benefits of working with Kalarippayattu training are self evident such as 
                                ...
                                the learner to be self-assured and at ease in situations. It encourages to develop skills 
                                to work in a world requiring teamwork, without compromising on individual creativity. 
                                Thus, this celestial art form on the one hand reinforce learning while on the other, 
                                encouraging creative and critical responses.</p>
                  </div>
                </div>
              </div>
            </div>
